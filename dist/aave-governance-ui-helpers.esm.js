import { GovernanceV3Ethereum, GovernanceV3Polygon, GovernanceV3Avalanche, GovernanceV3Base, GovernanceV3Arbitrum, GovernanceV3Metis, GovernanceV3Optimism, AaveV3Ethereum, AaveSafetyModule } from '@bgd-labs/aave-address-book';
...
var govCoreConfig = {
  mainnet: {
    ...
    votingPortals: (_votingPortals = {}, _votingPortals[ChainIdByName.EthereumMainnet] = GovernanceV3Ethereum.VOTING_PORTAL_ETH_ETH, _votingPortals[ChainIdByName.Polygon] = GovernanceV3Ethereum.VOTING_PORTAL_ETH_POL, _votingPortals[ChainIdByName.Avalanche] = GovernanceV3Ethereum.VOTING_PORTAL_ETH_AVAX, _votingPortals)
  },
  // testnets
  goerli: {
    ...
    votingPortals: (_votingPortals2 = {}, _votingPortals2[ChainIdByName.Goerli] = '0xFf376b6db4AF0d87Dba35860B3B87F526d7879cF', _votingPortals2)
  },
  sepolia: {
    ...
    votingPortals: (_votingPortals3 = {}, _votingPortals3[ChainIdByName.Sepolia] = '0x1079bAa48E56065d43b4344866B187a485cb0A92', _votingPortals3[ChainIdByName.AvalancheFuji] = '0x4f47EdF2577995aBd7B875Eed75b3F28a20E696F', _votingPortals3)
  }
};
var payloadsControllerConfig = {
  mainnet: (_mainnet = {}, _mainnet[ChainIdByName.EthereumMainnet] = {
    dataHelperContractAddress: GovernanceV3Ethereum.PC_DATA_HELPER,
    contractAddresses: [GovernanceV3Ethereum.PAYLOADS_CONTROLLER]
  }, _mainnet[ChainIdByName.Polygon] = {
    dataHelperContractAddress: GovernanceV3Polygon.PC_DATA_HELPER,
    contractAddresses: [GovernanceV3Polygon.PAYLOADS_CONTROLLER]
  }, _mainnet[ChainIdByName.Avalanche] = {
  ...
  }, _sepolia[ChainIdByName.AvalancheFuji] = {
    dataHelperContractAddress: '0x6B9AF21B95FE20b5a878b43670c23124841ec31A',
...
var votingMachineConfig = {
  mainnet: (_mainnet2 = {}, _mainnet2[ChainIdByName.EthereumMainnet] = {
  ...
  }, _mainnet2[ChainIdByName.Polygon] = {
  ...
  }, _mainnet2[ChainIdByName.Avalanche] = {
  ...
  }, _sepolia2[ChainIdByName.AvalancheFuji] = {
...
var payloadsControllerChainIds = {
  mainnet: [ChainIdByName.EthereumMainnet, ChainIdByName.Polygon, ChainIdByName.Avalanche, ChainIdByName.Base, ChainIdByName.Arbitrum, ChainIdByName.Metis, ChainIdByName.Optimism],
  goerli: [ChainIdByName.Goerli],
  sepolia: [ChainIdByName.Sepolia, ChainIdByName.AvalancheFuji]
};
var votingMachineChainIds = {
  mainnet: [ChainIdByName.EthereumMainnet, ChainIdByName.Polygon, ChainIdByName.Avalanche],
  goerli: [ChainIdByName.Goerli],
  sepolia: [ChainIdByName.Sepolia, ChainIdByName.AvalancheFuji]
};
var gelatoApiKeys = {
